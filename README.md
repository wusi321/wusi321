...
I'm **SulCunFur**, a junior undergraduate student interested in embedded systems and robotics development.

I have hands-on experience across the robotics development workflow, including mechanical modeling, embedded control, Linux-based development, simulation, and software implementation. My current focus is building practical engineering capability through real robot projects, competition experience, and continuous technical exploration.

🏆 **Awards**

- **National First Prize** — ROBOCON National Undergraduate Robot Contest
- **National Second Prize** — RoboCup China Open / National RoboCup Competition

<details>
  <summary><b>中文版个人简介（Click to expand）</b></summary>

  <p>你好，我是 <b>SulCunFur</b>，一名大三本科生，主要关注嵌入式开发与机器人开发方向。</p>

  <p>我拥有嵌入式开发和机器人开发全流程实战经验，参与过从机械结构设计、模型装配、URDF 导出，到机器人仿真、控制程序开发、嵌入式平台部署等环节的工程实践。</p>

  <p>我曾获得 <b>ROBOCON 全国大学生机器人大赛一等奖</b>、<b>ROBOCUP 全国二等奖</b>等奖项。目前仍在持续积累机器人系统开发、嵌入式 Linux、仿真工具链和工程化协作方面的能力。</p>

</details>

<i style="color: #007acc; display: inline;">Keep learning, keep building, and keep turning ideas into working robots.</i>
...
[![URDF](https://img.shields.io/badge/URDF-Robot_Modeling-2F81F7?style=flat-square&logo=ros&logoColor=white)](https://wiki.ros.org/urdf)

- SolidWorks modeling, assembly design, and mechanical structure iteration
- Workflow experience from CAD model design to assembly and URDF export

#### 🤖 Robotics & Simulation

[![ROS2](https://img.shields.io/badge/ROS2-22314E?style=flat-square&logo=ros&logoColor=white)](https://docs.ros.org/)
...
- Familiar with ROS2-based robot software development
- Experience with common robotics simulation tools including MuJoCo and Gazebo
- Practical understanding of robot model description, simulation setup, and development workflow
...
- C / C++ development for robotics and embedded systems
- Python scripting and tool development
- Linux multi-distribution usage and development experience
- Regular use of Git for version control and project collaboration
...
[![MSPM0](https://img.shields.io/badge/TI_MSPM0-CC0000?style=flat-square&logo=texasinstruments&logoColor=white)](https://www.ti.com/microcontrollers-mcus-processors/arm-based-microcontrollers/arm-cortex-m0-mcus/overview.html)
...
[![Orange Pi](https://img.shields.io/badge/Orange_Pi_Kunpeng_Pro-FF7900?style=flat-square&logo=linux&logoColor=white)](http://www.orangepi.org/)
[![Embedded Linux](https://img.shields.io/badge/Embedded_Linux-333333?style=flat-square&logo=linux&logoColor=white)](https://www.linuxfoundation.org/)

- STM32 and TI MSPM0 embedded development experience
- NVIDIA Jetson and Orange Pi Kunpeng Pro development experience
- Practical experience with embedded Linux development and deployment

---

### 📌 Current Interests

- Embedded control systems for mobile robots
...
<p align="center">
  <img alt="GitHub User's stars" src="https://img.shields.io/github/stars/wusi321?style=social&logo=github">
  <img alt="GitHub followers" src="https://img.shields.io/github/followers/wusi321?style=social&logo=github">
</p>
...
<p align="center">
  "Learning by building — from embedded boards to working robots." 🤖
</p>
